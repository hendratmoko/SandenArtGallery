...
if (link.includes('youtu')) {
   const vid = extractYT(link);
    ...
    // ditumpuk sebagai badge kecil di pojok, bukan elemen terpisah di
    // bawah gambar (yang sebelumnya bikin tinggi total melebihi kotak
    // dan poster jadi terpotong di bagian atas).
    ...
    media.innerHTML = `
        ...
        <span class="poster-category-badge">${w.work_category}</span>
    `;
}
    /*
    const media = card.querySelector('.card-media');
